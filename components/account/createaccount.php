    ...
    <body>
        <section class="container forms">
            <div class="back" onclick="history.back()">
                <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="white" class="bi bi-arrow-left-circle" viewBox="0 0 100 100">
            ...
            <div class="form login">
                ...
                <div class="media-options">
                    <a href="#" class="field google">
                        <img src="../../images/login/google.png" alt="" class="google-img">
